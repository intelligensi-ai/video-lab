  ...
  return (
    <main className="hero">
      ...
      <div className="prompts">
        <span>Neon rain over a glass city, anamorphic lens</span>
        <span>A desert observatory opening beneath the stars</span>
        <span>Macro crystal forest blooming in slow motion</span>
      </div>
