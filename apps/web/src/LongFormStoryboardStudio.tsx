      ...
      try {
        ...
        if (saved) {
          setForm({
            ...initialForm,
            ...saved,
            scenes: saved.scenes?.length ? saved.scenes.slice(0, MAX_STORYBOARD_SCENES) : initialScenes,
