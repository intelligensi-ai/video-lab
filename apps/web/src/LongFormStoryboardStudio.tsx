...
function Preview({ generation, loading, plannedTotalFrames, submissionError, cancelling, onCancel, cancelError }: { generation?: Generation; loading: boolean; plannedTotalFrames: number; submissionError?: string; cancelling: boolean; onCancel: () => void; cancelError?: string }) {
