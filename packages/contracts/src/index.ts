...
export interface RuntimeStatus { provider:string; status:'healthy'|'degraded'|'unavailable'|'paused'; acceptingSubmissions:boolean; killSwitch:boolean; lastHeartbeatAt?:string; activeGenerationId?:string; queueDepth:number; updatedAt:string; baseUrl?:string }
